...
## For deployment
# tunnel to the server using below command. Keep the tab open.
```
```
It will bind 2201 local port to the ssh port 22 of the server via a jump server.

# To deploy, run in separate tab
```
